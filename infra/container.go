...
func (c *ContainerDI) buildService() {
	...
	c.ServiceNewRoutes = new_routes.NewRoutesNewService(c.RepositoryRoutes, c.RepositoryRouteEnterprise, c.Config.GoogleMapsKey, c.ServiceZonasRisco, c.RepositoryAddress)
