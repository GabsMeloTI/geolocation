...
func (q *Queries) CreateAnnouncement(ctx context.Context, arg CreateAnnouncementParams) (Advertisement, error) {
...
func (q *Queries) GetAllAnnouncementUsers(ctx context.Context) (Advertisement, error) {
...
func (q *Queries) GetAnnouncementById(ctx context.Context, id int64) (Advertisement, error) {
...
func (q *Queries) UpdateAnnouncement(ctx context.Context, arg UpdateAnnouncementParams) (Advertisement, error) {
