...
func StartAPI(ctx context.Context, container *infra.ContainerDI) {
	...
	e.POST("/v2/route-cep", container.HandlerNewRoutes.CalculateRoutesCEPV2)
	...
	e.POST("/check-route-cep", container.HandlerNewRoutes.CalculateRoutesWithCEPOnly, _midlleware.CheckUserAuthorization)
	...
	address.GET("/find/random", container.HandlerAddress.FindTwoRandomCEPsHandler)
