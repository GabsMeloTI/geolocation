...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/geolocation_internal_new_routes.FinalOutput"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "geolocation_internal_new_routes.AddressInfo": {
            "type": "object",
            "properties": {
                "address": {
                    "type": "string"
        ...
        "geolocation_internal_new_routes.FinalOutput": {
            "type": "object",
            "properties": {
                "routes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/geolocation_internal_new_routes.RouteOutput"
                    }
                },
                "summary": {
        ...
        "geolocation_internal_new_routes.Instruction": {
            "type": "object",
            "properties": {
                "img": {
                    "type": "string"
        ...
        "geolocation_internal_new_routes.RouteOutput": {
            "type": "object",
            "properties": {
                "balances": {},
                "costs": {
                ...
                "instructions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/geolocation_internal_new_routes.Instruction"
                    }
                },
                "polyline": {
                    "type": "string"
                ...
                "summary": {
                    "$ref": "#/definitions/geolocation_internal_new_routes.RouteSummary"
                },
                "tolls": {
                    "type": "array",
                    "items": {
        ...
        "geolocation_internal_new_routes.RouteSummary": {
            "type": "object",
            "properties": {
                "distance": {
        ...
        "geolocation_internal_new_routes.Summary": {
            ...
            "properties": {
                ...
                "location_destination": {
                    "$ref": "#/definitions/geolocation_internal_new_routes.AddressInfo"
                },
                "location_origin": {
                    "$ref": "#/definitions/geolocation_internal_new_routes.AddressInfo"
                }
