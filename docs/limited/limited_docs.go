...
// SwaggerInfolimited holds exported Swagger Info so clients can modify it
var SwaggerInfolimited = &swag.Spec{
	Version:          "1.0",
	Host:             "",
	BasePath:         "",
	...
	InfoInstanceName: "limited",
	SwaggerTemplate:  docTemplatelimited,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerInfolimited.InstanceName(), SwaggerInfolimited)
}
